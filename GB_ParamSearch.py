...
# Import Data
df = pd.read_csv('/mnt/data/customerchurngit/prepared.csv', header=0, index_col=0)
...
# baseline data
df_baseline = pd.read_csv('/mnt/data/customerchurngit/churndata.csv', header=0, index_col=0)
